...
The thing is this ☝️ level of insanity is only really possible when you have all you can eat tokens, unless you're a fan of bankruptcy level AWS bills.
...
<br />
now have a lamp of `nearly infinite` software `wishes`;  
<br />
...
☝️ For the less technical, there are fake files called `1. Now, when processing, then` and so on, and these file names end up in the AI Agents `context window`.  
<br />
